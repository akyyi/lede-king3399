...
define Package/rp-king3399-firmware/install
	...
	$(INSTALL_DATA) ./brcm_firmware/ap6356s/brcmfmac4356-sdio.bin $(1)/lib/firmware/brcm/brcmfmac4356-sdio.rockchip,king3399.bin
	$(INSTALL_DATA) ./brcm_firmware/ap6356s/brcmfmac4356-sdio.txt $(1)/lib/firmware/brcm/brcmfmac4356-sdio.txt
	$(INSTALL_DATA) ./brcm_firmware/ap6356s/brcmfmac4356-sdio.txt $(1)/lib/firmware/brcm/brcmfmac4356-sdio.rockchip,king3399.txt
endef
$(eval $(call BuildPackage,rp-king3399-firmware))
