...
define Device/rp-king3399
  DEVICE_VENDOR := RP
  DEVICE_MODEL := King3399
  SOC := rk3399
  UBOOT_DEVICE_NAME := rp-king3399-rk3399
  IMAGE/sysupgrade.img.gz := boot-common | boot-script rp-king3399 | pine64-bin | gzip | append-metadata
  DEVICE_PACKAGES := kmod-usb-net-rtl8152 kmod-usb-net-asix-ax88179 kmod-brcmfmac kmod-brcmutil kmod-hwmon-core kmod-hwmon-gpiofan arm-trusted-firmware-rk3399 arm-trusted-firmware-rockchip rp-king3399-firmware u-boot-rp-king3399-rk3399 hostapd wpa-supplicant -urngd kmod-usb3 wpad-openssl
endef
TARGET_DEVICES += rp-king3399
